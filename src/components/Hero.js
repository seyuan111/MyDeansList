...
const Hero = () => {
  return (
    ...
    <div className="w-full h-[90%] text-center flex flex-col items-center justify-center px-4 text-white">
        ...
        <h1 className="text-[25px] mt-8 text-white">Where you can add your members</h1>
        <p className="text-[20px] my-5 font-bold">This is like a business card. It is convenient in case you lose your business card. You can add it online</p>
        ...
        <div className="text-white">
            ...
            <button className="px-6 py-2 bg-red-500 hover:bg-red-900 rounded text-white duration-300 ml-6"><Link href="/Home">View Members</Link></button>
        </div>
    </div>
